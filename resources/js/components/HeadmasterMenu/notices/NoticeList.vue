    ...
    <HeadmasterLayout>
        ...
        <div class="overflow-x-auto rounded-lg bg-white shadow">
            <table class="min-w-full table-auto text-left">
                ...
                <tbody>
                    <tr v-for="(n, index) in notices" :key="n.id" :class="[
                        ...
                        <td class="px-4 py-3">
                            {{n.class_ids?.map((id: number) => classes.find(c => c.id === id)?.name).join(', ')}}
                        </td>
                        <td class="px-4 py-3">
                            {{n.section_ids?.map((id: number) => sections.find(s => s.id === id)?.name).join(', ') ||
                            'N/A' }}
                        </td>
                        <td class="px-4 py-3 flex justify-center gap-2">
                            <button @click="openForm(n)"
                                class="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700">
                                Edit
                            </button>
                            <button @click="deleteNotice(n.id)"
        ...
        <div class="flex justify-between items-center mt-4">
            ...
            <div class="flex gap-1">
                <button :disabled="meta.current_page === 1" @click="loadNotices(meta.current_page - 1)"
                ...
                <button :disabled="meta.current_page === meta.last_page" @click="loadNotices(meta.current_page + 1)"
